...
public abstract class ByteString implements Iterable<Byte>, Serializable {
  ...
  static int checkRange(int paramInt1, int paramInt2, int paramInt3) {
    ...
    if ((paramInt1 | paramInt2 | i | paramInt3 - paramInt2) < 0) {
      if (paramInt1 < 0) {
        StringBuilder stringBuilder1 = new StringBuilder();
        stringBuilder1.append("Beginning index: ");
        stringBuilder1.append(paramInt1);
  ...
  private static class LiteralByteString extends LeafByteString {
    ...
    final boolean equalsRange(ByteString param1ByteString, int param1Int1, int param1Int2) {
      ...
      if (i > stringBuilder.size()) {
        ...
        stringBuilder1.append(", ");
        stringBuilder1.append(stringBuilder.size());
        throw new IllegalArgumentException(stringBuilder1.toString());
      } 
      if (stringBuilder instanceof LiteralByteString) {
        LiteralByteString literalByteString = (LiteralByteString)stringBuilder;
        byte[] arrayOfByte1 = this.bytes;
        arrayOfByte = literalByteString.bytes;
        int j = getOffsetIntoBytes();
        i = getOffsetIntoBytes();
        for (param1Int1 = literalByteString.getOffsetIntoBytes() + param1Int1; i < j + param1Int2; param1Int1++) {
          if (arrayOfByte1[i] != arrayOfByte[param1Int1])
            return false; 
          i++;
        } 
        return true;
...
/* Location:              C:\Users\rafal\Downloads\Mobius_jar.jar!\com\google\protobuf\ByteString.class
