...
public enum FieldType {
  ...
  static {
    ...
    while (b < i) {
      FieldType fieldType1 = arrayOfFieldType[b];
  ...
  FieldType(int paramInt1, Collection paramCollection, JavaType paramJavaType) {
    ...
    this.primitiveScalar = bool2;
  }
  
  public static FieldType forId(int paramInt) {
    return (paramInt < 0 || paramInt >= VALUES.length) ? null : VALUES[paramInt];
  }
    ...
    label43: while (true) {
      ...
      if (paramClass != List.class) {
        ...
        if (type2 instanceof ParameterizedType) {
          ...
          for (b = 0; b < arrayOfType.length; b++) {
            ...
            if (type instanceof TypeVariable) {
              ...
              while (true) {
                if (b1 < arrayOfTypeVariable.length) {
                  if (type == arrayOfTypeVariable[b1]) {
                    arrayOfType[b] = paramArrayOfType[b1];
                    b1 = 1;
                    break;
                  } 
                  b1++;
...
/* Location:              C:\Users\rafal\Downloads\Mobius_jar.jar!\com\google\protobuf\FieldType.class
