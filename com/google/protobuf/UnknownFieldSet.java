...
public final class UnknownFieldSet implements MessageLite {
  ...
  public boolean equals(Object paramObject) {
    ...
    if (this == paramObject)
      return true; 
    if (!(paramObject instanceof UnknownFieldSet) || !this.fields.equals(((UnknownFieldSet)paramObject).fields))
      bool = false; 
    return bool;
  }
  ...
  public Field getField(int paramInt) {
    Field field1 = this.fields.get(Integer.valueOf(paramInt));
    Field field2 = field1;
    if (field1 == null)
  ...
  public static final class Builder implements MessageLite.Builder {
    ...
    private UnknownFieldSet.Field.Builder getFieldBuilder(int param1Int) {
      if (this.lastField != null) {
        if (param1Int == this.lastFieldNumber)
...
/* Location:              C:\Users\rafal\Downloads\Mobius_jar.jar!\com\google\protobuf\UnknownFieldSet.class
