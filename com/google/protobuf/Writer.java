...
interface Writer {
  ...
  void writeEnum(int paramInt1, int paramInt2) throws IOException;
  ...
  void writeInt32(int paramInt1, int paramInt2) throws IOException;
  
  void writeInt32List(int paramInt, List<Integer> paramList, boolean paramBoolean) throws IOException;
  
  void writeInt64(int paramInt, long paramLong) throws IOException;
  ...
  void writeSFixed32(int paramInt1, int paramInt2) throws IOException;
  
  void writeSFixed32List(int paramInt, List<Integer> paramList, boolean paramBoolean) throws IOException;
  
  void writeSFixed64(int paramInt, long paramLong) throws IOException;
  ...
  void writeUInt64(int paramInt, long paramLong) throws IOException;
...
/* Location:              C:\Users\rafal\Downloads\Mobius_jar.jar!\com\google\protobuf\Writer.class
