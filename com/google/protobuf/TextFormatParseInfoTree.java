...
public class TextFormatParseInfoTree {
  ...
  public static class Builder {
    ...
    public Builder getBuilderForSubMessageField(Descriptors.FieldDescriptor param1FieldDescriptor) {
      List<Builder> list1 = this.subtreeBuildersFromField.get(param1FieldDescriptor);
      List<Builder> list2 = list1;
      if (list1 == null) {
        list2 = new ArrayList();
        this.subtreeBuildersFromField.put(param1FieldDescriptor, list2);
      } 
    ...
    public Builder setLocation(Descriptors.FieldDescriptor param1FieldDescriptor, TextFormatParseLocation param1TextFormatParseLocation) {
      List<TextFormatParseLocation> list1 = this.locationsFromField.get(param1FieldDescriptor);
      List<TextFormatParseLocation> list2 = list1;
      if (list1 == null) {
        list2 = new ArrayList();
        this.locationsFromField.put(param1FieldDescriptor, list2);
      } 
      list2.add(param1TextFormatParseLocation);
      return this;
    }
  }
}
...
/* Location:              C:\Users\rafal\Downloads\Mobius_jar.jar!\com\google\protobuf\TextFormatParseInfoTree.class
