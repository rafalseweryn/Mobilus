...
public class DiffUtil {
  ...
  private static Snake diffPartial(Callback paramCallback, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int[] paramArrayOfint1, int[] paramArrayOfint2, int paramInt5) {
    ...
    if (i < 1 || paramInt2 < 1)
      return null; 
    int j = i - paramInt2;
    int k = (i + paramInt2 + 1) / 2;
    int m = paramInt5 - k - 1;
    paramInt4 = paramInt5 + k + 1;
    Arrays.fill(paramArrayOfint1, m, paramInt4, 0);
    Arrays.fill(paramArrayOfint2, m + j, paramInt4 + j, i);
    if (j % 2 != 0) {
      m = 1;
    } else {
      m = 0;
  ...
  public static class DiffResult {
    ...
    public int convertNewPositionToOld(@IntRange(from = 0L) int param1Int) {
      if (param1Int < 0 || param1Int >= this.mNewItemStatuses.length) {
    ...
    public int convertOldPositionToNew(@IntRange(from = 0L) int param1Int) {
      if (param1Int < 0 || param1Int >= this.mOldItemStatuses.length) {
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("Index out of bounds - passed position = ");
        stringBuilder.append(param1Int);
    ...
    public void dispatchUpdatesTo(@NonNull ListUpdateCallback param1ListUpdateCallback) {
    ...
    public void dispatchUpdatesTo(@NonNull RecyclerView.Adapter param1Adapter) {
  ...
  public static abstract class ItemCallback<T> {
    public abstract boolean areContentsTheSame(@NonNull T param1T1, @NonNull T param1T2);
    
    public abstract boolean areItemsTheSame(@NonNull T param1T1, @NonNull T param1T2);
    
    @Nullable
    public Object getChangePayload(@NonNull T param1T1, @NonNull T param1T2) {
      return null;
    }
  }
...
/* Location:              C:\Users\rafal\Downloads\Mobius_jar.jar!\android\support\v\\util\DiffUtil.class
