...
public class AsyncListUtil<T> {
  ...
  public static abstract class DataCallback<T> {
    @WorkerThread
    public abstract void fillData(@NonNull T[] param1ArrayOfT, int param1Int1, int param1Int2);
    ...
    @WorkerThread
    public void recycleData(@NonNull T[] param1ArrayOfT, int param1Int) {}
  ...
  public static abstract class ViewCallback {
    ...
    @UiThread
    public void extendRangeInto(@NonNull int[] param1ArrayOfint1, @NonNull int[] param1ArrayOfint2, int param1Int) {
    ...
    @UiThread
    public abstract void getItemRangeInto(@NonNull int[] param1ArrayOfint);
...
/* Location:              C:\Users\rafal\Downloads\Mobius_jar.jar!\android\support\v\\util\AsyncListUtil.class
