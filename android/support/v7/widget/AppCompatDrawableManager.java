...
public final class AppCompatDrawableManager {
        ...
        if (typedValue.string.toString().endsWith(".xml")) {
          ...
          try {
            ...
            if (inflateDelegate != null) {
              drawable2 = drawable1;
              drawable = inflateDelegate.createFromXmlInner((Context)xmlPullParserException, (XmlPullParser)xmlResourceParser, attributeSet, xmlPullParserException.getTheme());
            } 
            drawable2 = drawable;
            if (drawable != null) {
              drawable2 = drawable;
              ...
              drawable2 = drawable;
              addDrawableToCache((Context)xmlPullParserException, l, drawable);
              drawable2 = drawable;
            } 
  ...
  static boolean tintDrawableUsingColorFilter(@NonNull Context paramContext, @DrawableRes int paramInt, @NonNull Drawable paramDrawable) {
    ...
    //   38: istore_1
    //   39: goto -> 122
    //   42: getstatic android/support/v7/widget/AppCompatDrawableManager.COLORFILTER_COLOR_CONTROL_ACTIVATED : [I
    //   45: iload_1
    //   46: invokestatic arrayContains : ([II)Z
    //   49: ifeq -> 59
    //   52: getstatic android/support/v7/appcompat/R$attr.colorControlActivated : I
    //   55: istore_1
    //   56: goto -> 27
    //   59: getstatic android/support/v7/widget/AppCompatDrawableManager.COLORFILTER_COLOR_BACKGROUND_MULTIPLY : [I
    //   62: iload_1
    //   63: invokestatic arrayContains : ([II)Z
    //   66: ifeq -> 79
    ...
    //   76: goto -> 27
    //   79: iload_1
    //   80: getstatic android/support/v7/appcompat/R$drawable.abc_list_divider_mtrl_alpha : I
    //   83: if_icmpne -> 101
    //   86: ldc_w 16842800
    //   89: istore_1
    //   90: ldc_w 40.8
    //   93: invokestatic round : (F)I
    //   96: istore #5
    //   98: goto -> 30
    //   101: iload_1
    //   102: getstatic android/support/v7/appcompat/R$drawable.abc_dialog_material_background : I
    //   105: if_icmpne -> 114
    //   108: iload #5
    //   110: istore_1
    //   111: goto -> 27
    ...
    //   127: astore #8
    //   129: aload_2
    //   130: invokestatic canSafelyMutateDrawable : (Landroid/graphics/drawable/Drawable;)Z
    //   133: ifeq -> 142
    //   136: aload_2
    ...
    //   144: aload_0
    //   145: iload #7
    //   147: invokestatic getThemeAttrColor : (Landroid/content/Context;I)I
    //   150: aload_3
    //   151: invokestatic getPorterDuffColorFilter : (ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
...
/* Location:              C:\Users\rafal\Downloads\Mobius_jar.jar!\android\support\v7\widget\AppCompatDrawableManager.class
