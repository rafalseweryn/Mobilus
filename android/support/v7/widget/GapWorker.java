  ...
  private void buildTaskList() {
    ...
    while (k < i) {
      ...
      if (recyclerView.getWindowVisibility() == 0) {
        ...
        int m = Math.abs(layoutPrefetchRegistryImpl.mPrefetchDx) + Math.abs(layoutPrefetchRegistryImpl.mPrefetchDy);
        for (byte b = 0; b < layoutPrefetchRegistryImpl.mCount * 2; b += 2) {
          ...
          int n = layoutPrefetchRegistryImpl.mPrefetchArray[b + 1];
          if (n <= m) {
            bool = true;
          } else {
            bool = false;
...
/* Location:              C:\Users\rafal\Downloads\Mobius_jar.jar!\android\support\v7\widget\GapWorker.class
