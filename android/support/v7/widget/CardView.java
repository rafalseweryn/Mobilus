  ...
  public CardView(@NonNull Context paramContext, @Nullable AttributeSet paramAttributeSet, int paramInt) {
    ...
    this.mCardViewDelegate = new CardViewDelegate() {
        ...
        public void setShadowPadding(int param1Int1, int param1Int2, int param1Int3, int param1Int4) {
          ...
          CardView.this.setPadding(param1Int1 + CardView.this.mContentPadding.left, param1Int2 + CardView.this.mContentPadding.top, param1Int3 + CardView.this.mContentPadding.right, param1Int4 + CardView.this.mContentPadding.bottom);
        }
      };
...
/* Location:              C:\Users\rafal\Downloads\Mobius_jar.jar!\android\support\v7\widget\CardView.class
