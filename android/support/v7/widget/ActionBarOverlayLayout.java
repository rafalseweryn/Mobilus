...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
  ...
  protected void onMeasure(int paramInt1, int paramInt2) {
    ...
    setMeasuredDimension(View.resolveSizeAndState(Math.max(i1 + j + n, getSuggestedMinimumWidth()), paramInt1, k), View.resolveSizeAndState(m, paramInt2, k << 16));
  }
...
/* Location:              C:\Users\rafal\Downloads\Mobius_jar.jar!\android\support\v7\widget\ActionBarOverlayLayout.class
