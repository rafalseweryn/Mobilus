  ...
  static class BoundFlags {
    ...
    boolean boundsMatch() {
      ...
      if ((this.mBoundFlags & 0x700) != 0 && (this.mBoundFlags & compare(this.mChildEnd, this.mRvStart) << 8) == 0)
        return false; 
      if ((this.mBoundFlags & 0x7000) != 0) {
        int i = this.mBoundFlags;
        if ((compare(this.mChildEnd, this.mRvEnd) << 12 & i) == 0)
          return false; 
      } 
      return true;
    }
...
/* Location:              C:\Users\rafal\Downloads\Mobius_jar.jar!\android\support\v7\widget\ViewBoundsCheck.class
