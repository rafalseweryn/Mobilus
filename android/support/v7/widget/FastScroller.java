...
class FastScroller extends RecyclerView.ItemDecoration implements RecyclerView.OnItemTouchListener {
  ...
  boolean isPointInsideVerticalThumb(float paramFloat1, float paramFloat2) {
    boolean bool;
    if ((isLayoutRTL() ? (paramFloat1 <= (this.mVerticalThumbWidth / 2)) : (paramFloat1 >= (this.mRecyclerViewWidth - this.mVerticalThumbWidth))) && paramFloat2 >= (this.mVerticalThumbCenterY - this.mVerticalThumbHeight / 2) && paramFloat2 <= (this.mVerticalThumbCenterY + this.mVerticalThumbHeight / 2)) {
      bool = true;
    } else {
      bool = false;
    } 
  ...
  public boolean onInterceptTouchEvent(@NonNull RecyclerView paramRecyclerView, @NonNull MotionEvent paramMotionEvent) {
    ...
    //   109: aload_0
    //   110: iconst_2
    //   111: invokevirtual setState : (I)V
    //   114: goto -> 129
    //   117: iload #4
    //   119: istore #7
    //   121: aload_0
...
/* Location:              C:\Users\rafal\Downloads\Mobius_jar.jar!\android\support\v7\widget\FastScroller.class
