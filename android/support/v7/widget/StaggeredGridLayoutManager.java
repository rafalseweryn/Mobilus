...
public class StaggeredGridLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
  ...
  private int fill(RecyclerView.Recycler paramRecycler, LayoutState paramLayoutState, RecyclerView.State paramState) {
    ...
    int m;
    for (m = 0; paramLayoutState.hasMore(paramState) && (this.mLayoutState.mInfinite || !this.mRemainingSpans.isEmpty()); m = 1) {
      Span span;
      int i1;
      int i2;
      ...
      if (paramLayoutState.mLayoutDirection == 1) {
        ...
        i2 = j - this.mPrimaryOrientation.getDecoratedMeasurement(view);
        if (i1 != 0 && layoutParams.mFullSpan) {
      ...
      if (isLayoutRTL() && this.mOrientation == 1) {
        ...
        n = this.mSecondaryOrientation.getDecoratedMeasurement(view);
        i1 = j;
        n = j - n;
        j = i1;
      } else {
      ...
      if (this.mOrientation == 1) {
        layoutDecoratedWithMargins(view, n, i2, j, m);
      } else {
        layoutDecoratedWithMargins(view, i2, n, m, j);
      } 
      if (layoutParams.mFullSpan) {
  ...
  private void updateLayoutState(int paramInt, RecyclerView.State paramState) {
    ...
    //   79: goto -> 101
    //   82: aload_0
    //   83: getfield mPrimaryOrientation : Landroid/support/v7/widget/OrientationHelper;
    //   86: invokevirtual getTotalSpace : ()I
    //   89: istore_1
    //   90: iconst_0
    //   91: istore #5
    //   93: goto -> 101
    ...
    //   99: istore #5
    //   101: aload_0
    //   102: invokevirtual getClipToPadding : ()Z
    //   105: ifeq -> 144
    //   108: aload_0
    //   109: getfield mLayoutState : Landroid/support/v7/widget/LayoutState;
    //   112: aload_0
    //   113: getfield mPrimaryOrientation : Landroid/support/v7/widget/OrientationHelper;
    //   116: invokevirtual getStartAfterPadding : ()I
    //   119: iload_1
    //   120: isub
    //   121: putfield mStartLine : I
    //   124: aload_0
    //   125: getfield mLayoutState : Landroid/support/v7/widget/LayoutState;
    //   128: aload_0
    //   129: getfield mPrimaryOrientation : Landroid/support/v7/widget/OrientationHelper;
    //   132: invokevirtual getEndAfterPadding : ()I
    //   135: iload #5
    //   137: iadd
    //   138: putfield mEndLine : I
    //   141: goto -> 170
    //   144: aload_0
    //   145: getfield mLayoutState : Landroid/support/v7/widget/LayoutState;
    //   148: aload_0
    //   149: getfield mPrimaryOrientation : Landroid/support/v7/widget/OrientationHelper;
    //   152: invokevirtual getEnd : ()I
    //   155: iload #5
    //   157: iadd
    //   158: putfield mEndLine : I
    //   161: aload_0
    //   162: getfield mLayoutState : Landroid/support/v7/widget/LayoutState;
    //   165: iload_1
    //   166: ineg
    //   167: putfield mStartLine : I
    //   170: aload_0
    //   171: getfield mLayoutState : Landroid/support/v7/widget/LayoutState;
    //   174: iconst_0
    //   175: putfield mStopInFocusable : Z
    //   178: aload_0
    //   179: getfield mLayoutState : Landroid/support/v7/widget/LayoutState;
    //   182: iconst_1
    //   183: putfield mRecycle : Z
    //   186: aload_0
    //   187: getfield mLayoutState : Landroid/support/v7/widget/LayoutState;
    //   190: astore_2
    //   191: iload #4
    //   193: istore #7
    //   195: aload_0
    //   196: getfield mPrimaryOrientation : Landroid/support/v7/widget/OrientationHelper;
    //   199: invokevirtual getMode : ()I
    //   202: ifne -> 222
    //   205: iload #4
    //   207: istore #7
    //   209: aload_0
    //   210: getfield mPrimaryOrientation : Landroid/support/v7/widget/OrientationHelper;
    //   213: invokevirtual getEnd : ()I
    //   216: ifne -> 222
    //   219: iconst_1
    //   220: istore #7
    //   222: aload_2
    //   223: iload #7
    //   225: putfield mInfinite : Z
    //   228: return
  }
  ...
  public void collectAdjacentPrefetchPositions(int paramInt1, int paramInt2, RecyclerView.State paramState, RecyclerView.LayoutManager.LayoutPrefetchRegistry paramLayoutPrefetchRegistry) {
    ...
    boolean bool = false;
    paramInt2 = 0;
    for (paramInt1 = paramInt2; paramInt2 < this.mSpanCount; paramInt1 = j) {
      int i;
...
/* Location:              C:\Users\rafal\Downloads\Mobius_jar.jar!\android\support\v7\widget\StaggeredGridLayoutManager.class
