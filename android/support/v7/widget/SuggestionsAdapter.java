...
class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
  ...
  private Drawable getDrawable(Uri paramUri) {
    try {
      ...
      try {
        return Drawable.createFromStream((InputStream)fileNotFoundException, null);
      } finally {
        try {
          stringBuilder.close();
...
/* Location:              C:\Users\rafal\Downloads\Mobius_jar.jar!\android\support\v7\widget\SuggestionsAdapter.class
