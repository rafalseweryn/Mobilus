...
public class Toolbar extends ViewGroup {
  ...
  private int layoutChildRight(View paramView, int paramInt1, int[] paramArrayOfint, int paramInt2) {
    ...
    return paramInt1 - paramInt2 + layoutParams.leftMargin;
  }
  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4) {
    ...
    if (shouldLayout((View)this.mLogoView))
      if (i) {
        paramInt2 = layoutChildRight((View)this.mLogoView, i4, arrayOfInt, paramInt4);
        paramInt3 = paramInt1;
      } else {
  ...
  protected void onMeasure(int paramInt1, int paramInt2) {
    ...
    k = n;
    if (shouldLayout((View)this.mLogoView)) {
      i = j + measureChildCollapseMargins((View)this.mLogoView, paramInt1, j, paramInt2, 0, arrayOfInt);
      i2 = Math.max(m, this.mLogoView.getMeasuredHeight() + getVerticalMargins((View)this.mLogoView));
    ...
    for (j = i2; n < i3; j = i2) {
      ...
      if (((LayoutParams)view.getLayoutParams()).mViewType == 0)
        if (!shouldLayout(view)) {
          ...
          i2 = Math.max(j, view.getMeasuredHeight() + getVerticalMargins(view));
    ...
    if (shouldLayout((View)this.mTitleTextView)) {
      ...
      i2 = this.mTitleTextView.getMeasuredHeight();
    ...
    if (shouldLayout((View)this.mSubtitleTextView)) {
      n = Math.max(n, measureChildCollapseMargins((View)this.mSubtitleTextView, paramInt1, m + i1, paramInt2, i2 + i, arrayOfInt));
    ...
    paramInt1 = View.resolveSizeAndState(Math.max(i + i2 + j, getSuggestedMinimumHeight()), paramInt2, k << 16);
    if (shouldCollapse())
      paramInt1 = 0; 
...
/* Location:              C:\Users\rafal\Downloads\Mobius_jar.jar!\android\support\v7\widget\Toolbar.class
