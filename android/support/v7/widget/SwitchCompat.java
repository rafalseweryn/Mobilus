...
public class SwitchCompat extends CompoundButton {
  ...
  private boolean hitThumb(float paramFloat1, float paramFloat2) {
    ...
    i = this.mSwitchLeft + i - this.mTouchSlop;
  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4) {
    ...
    if (drawable != null) {
      ...
      paramInt2 = Math.max(0, rect1.left - rect2.left);
      paramInt1 = Math.max(0, rect1.right - rect2.right);
    } else {
      paramInt1 = 0;
    } 
    if (ViewUtils.isLayoutRtl((View)this)) {
...
/* Location:              C:\Users\rafal\Downloads\Mobius_jar.jar!\android\support\v7\widget\SwitchCompat.class
