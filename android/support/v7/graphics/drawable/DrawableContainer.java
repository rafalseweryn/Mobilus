...
class DrawableContainer extends Drawable implements Drawable.Callback {
  ...
  public int getChangingConfigurations() {
    ...
    return this.mDrawableContainerState.getChangingConfigurations() | i;
  }
  ...
  static abstract class DrawableContainerState extends Drawable.ConstantState {
    ...
    public int getChangingConfigurations() {
      ...
      return this.mChildrenChangingConfigurations | i;
    }
    ...
    final boolean setLayoutDirection(int param1Int1, int param1Int2) {
      ...
      for (b2 = b1; b1 < i; b2 = b) {
        ...
        if (arrayOfDrawable[b1] != null) {
          boolean bool;
          if (Build.VERSION.SDK_INT >= 23) {
            bool = arrayOfDrawable[b1].setLayoutDirection(param1Int1);
          } else {
            bool = false;
          } 
          b = b2;
...
/* Location:              C:\Users\rafal\Downloads\Mobius_jar.jar!\android\support\v7\graphics\drawable\DrawableContainer.class
