...
public class MaterialShapeDrawable extends Drawable implements TintAwareDrawable {
  ...
  public void getPathForSize(int paramInt1, int paramInt2, Path paramPath) {
    ...
    while (b3 < 4) {
      appendCornerPath(b3, paramPath);
      appendEdgePath(b3, paramPath);
      b3++;
    } 
    paramPath.close();
  }
...
/* Location:              C:\Users\rafal\Downloads\Mobius_jar.jar!\android\support\design\shape\MaterialShapeDrawable.class
