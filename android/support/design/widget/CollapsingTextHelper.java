...
public final class CollapsingTextHelper {
  ...
  private void ensureExpandedTexture() {
    ...
    (new Canvas(this.expandedTitleTexture)).drawText(this.textToDraw, 0, this.textToDraw.length(), 0.0F, j - this.textPaint.descent(), (Paint)this.textPaint);
  ...
  public void draw(Canvas paramCanvas) {
    ...
    if (this.textToDraw != null && this.drawTitle) {
      ...
      if (bool) {
        ...
        float f = this.textureDescent;
        f = this.scale;
      } else {
        f3 = this.textPaint.ascent() * this.scale;
      ...
      if (bool)
        f4 = f2 + f3; 
      if (this.scale != 1.0F)
        paramCanvas.scale(this.scale, this.scale, f1, f4); 
      if (bool) {
        paramCanvas.drawBitmap(this.expandedTitleTexture, f1, f4, this.texturePaint);
      } else {
        paramCanvas.drawText(this.textToDraw, 0, this.textToDraw.length(), f1, f4, (Paint)this.textPaint);
      } 
    } 
...
/* Location:              C:\Users\rafal\Downloads\Mobius_jar.jar!\android\support\design\widget\CollapsingTextHelper.class
