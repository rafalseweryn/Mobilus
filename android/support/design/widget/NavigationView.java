...
public class NavigationView extends ScrimInsetsFrameLayout {
  ...
  private ColorStateList createDefaultColorStateList(int paramInt) {
    ...
    return new ColorStateList(new int[][] { arrayOfInt2, arrayOfInt1, arrayOfInt3 }, new int[] { j, paramInt, i });
  }
...
/* Location:              C:\Users\rafal\Downloads\Mobius_jar.jar!\android\support\design\widget\NavigationView.class
