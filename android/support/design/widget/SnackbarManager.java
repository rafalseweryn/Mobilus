...
class SnackbarManager {
  ...
  private boolean isCurrentSnackbarLocked(Callback paramCallback) {
    boolean bool;
    if (this.currentSnackbar != null && this.currentSnackbar.isSnackbar(paramCallback)) {
      bool = true;
    } else {
      bool = false;
    } 
  ...
  private boolean isNextSnackbarLocked(Callback paramCallback) {
    boolean bool;
    if (this.nextSnackbar != null && this.nextSnackbar.isSnackbar(paramCallback)) {
      bool = true;
    } else {
      bool = false;
    } 
...
/* Location:              C:\Users\rafal\Downloads\Mobius_jar.jar!\android\support\design\widget\SnackbarManager.class
