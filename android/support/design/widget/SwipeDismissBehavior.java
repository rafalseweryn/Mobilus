...
public class SwipeDismissBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
  ...
  private final ViewDragHelper.Callback dragCallback = new ViewDragHelper.Callback() {
      ...
      private boolean shouldDismiss(View param1View, float param1Float) {
        ...
        i = Math.round(param1View.getWidth() * SwipeDismissBehavior.this.dragDismissThreshold);
        bool3 = bool2;
        if (Math.abs(k - j) >= i)
          bool3 = true; 
        return bool3;
      ...
      public void onViewReleased(View param1View, float param1Float1, float param1Float2) {
        ...
        if (shouldDismiss(param1View, param1Float1)) {
          if (param1View.getLeft() < this.originalCapturedViewLeft) {
  ...
  public int getDragState() {
    boolean bool;
    if (this.viewDragHelper != null) {
      bool = this.viewDragHelper.getViewDragState();
    } else {
      bool = false;
    } 
    return bool;
...
/* Location:              C:\Users\rafal\Downloads\Mobius_jar.jar!\android\support\design\widget\SwipeDismissBehavior.class
