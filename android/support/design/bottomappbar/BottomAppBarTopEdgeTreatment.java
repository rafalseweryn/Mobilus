...
public class BottomAppBarTopEdgeTreatment extends EdgeTreatment {
  ...
  public void getEdgePath(float paramFloat1, float paramFloat2, ShapePath paramShapePath) {
    ...
    f4 = f3 - f6;
    float f7 = f3 + f6;
    float f8 = (float)Math.toDegrees(Math.atan((f6 / f5)));
    f5 = 90.0F - f8;
    f6 = f4 - f2;
    paramShapePath.lineTo(f6, 0.0F);
    float f9 = f2 * 2.0F;
    paramShapePath.addArc(f6, 0.0F, f4 + f2, f9, 270.0F, f8);
    paramShapePath.addArc(f3 - f1, -f1 - paramFloat2, f3 + f1, f1 - paramFloat2, 180.0F - f5, f5 * 2.0F - 180.0F);
    paramShapePath.addArc(f7 - f2, 0.0F, f7 + f2, f9, 270.0F - f8, f8);
    paramShapePath.lineTo(paramFloat1, 0.0F);
  }
...
/* Location:              C:\Users\rafal\Downloads\Mobius_jar.jar!\android\support\design\bottomappbar\BottomAppBarTopEdgeTreatment.class
