...
public class BottomAppBar extends Toolbar implements CoordinatorLayout.AttachedBehavior {
  ...
  private float getFabTranslationY(boolean paramBoolean) {
    ...
    float f5 = f2 / 2.0F;
    f2 = f4 - floatingActionButton.getPaddingBottom();
  ...
  private void maybeAnimateMenuView(int paramInt, boolean paramBoolean) {
    ...
    createMenuViewTranslationAnimation(paramInt, i, arrayList);
    AnimatorSet animatorSet = new AnimatorSet();
    animatorSet.playTogether(arrayList);
  ...
  public static class Behavior extends HideBottomViewOnScrollBehavior<BottomAppBar> {
    ...
    public boolean onStartNestedScroll(@NonNull CoordinatorLayout param1CoordinatorLayout, @NonNull BottomAppBar param1BottomAppBar, @NonNull View param1View1, @NonNull View param1View2, int param1Int1, int param1Int2) {
      boolean bool;
...
/* Location:              C:\Users\rafal\Downloads\Mobius_jar.jar!\android\support\design\bottomappbar\BottomAppBar.class
