...
public final class ThemeEnforcement {
  ...
  private static void checkTextAppearance(Context paramContext, AttributeSet paramAttributeSet, @StyleableRes int[] paramArrayOfint1, @AttrRes int paramInt1, @StyleRes int paramInt2, @StyleableRes int... paramVarArgs1) {
    TypedArray typedArray = paramContext.obtainStyledAttributes(paramAttributeSet, R.styleable.ThemeEnforcement, paramInt1, paramInt2);
  ...
  private static boolean isCustomTextAppearanceValid(Context paramContext, AttributeSet paramAttributeSet, @StyleableRes int[] paramArrayOfint1, @AttrRes int paramInt1, @StyleRes int paramInt2, @StyleableRes int... paramVarArgs1) {
  ...
  public static TypedArray obtainStyledAttributes(Context paramContext, AttributeSet paramAttributeSet, @StyleableRes int[] paramArrayOfint1, @AttrRes int paramInt1, @StyleRes int paramInt2, @StyleableRes int... paramVarArgs1) {
  ...
  public static TintTypedArray obtainTintedStyledAttributes(Context paramContext, AttributeSet paramAttributeSet, @StyleableRes int[] paramArrayOfint1, @AttrRes int paramInt1, @StyleRes int paramInt2, @StyleableRes int... paramVarArgs1) {
    checkCompatibleTheme(paramContext, paramAttributeSet, paramInt1, paramInt2);
    checkTextAppearance(paramContext, paramAttributeSet, paramArrayOfint1, paramInt1, paramInt2, paramVarArgs1);
...
/* Location:              C:\Users\rafal\Downloads\Mobius_jar.jar!\android\support\design\internal\ThemeEnforcement.class
