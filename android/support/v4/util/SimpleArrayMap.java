...
public class SimpleArrayMap<K, V> {
  ...
  public V put(K paramK, V paramV) {
    ...
    if (m < i) {
      ...
      j = m + 1;
      System.arraycopy(arrayOfInt2, m, arrayOfInt1, j, i - m);
      System.arraycopy(this.mArray, m << 1, this.mArray, j << 1, this.mSize - m << 1);
    } 
    if (i != this.mSize || m >= this.mHashes.length)
      throw new ConcurrentModificationException(); 
    this.mHashes[m] = k;
    Object[] arrayOfObject = this.mArray;
    int j = m << 1;
    arrayOfObject[j] = paramK;
    this.mArray[j + 1] = paramV;
    this.mSize++;
    return null;
  }
    ...
    if (j <= 1) {
      ...
      if (n > 8 && this.mSize < this.mHashes.length / 3) {
        ...
        if (paramInt < m) {
          ...
          System.arraycopy(arrayOfObject1, n << 1, this.mArray, i, k << 1);
        } 
      } else {
        if (paramInt < m) {
          int[] arrayOfInt1 = this.mHashes;
          ...
          System.arraycopy(this.mArray, k << 1, this.mArray, i, n << 1);
        } 
        Object[] arrayOfObject1 = this.mArray;
        paramInt = m << 1;
...
/* Location:              C:\Users\rafal\Downloads\Mobius_jar.jar!\android\support\v\\util\SimpleArrayMap.class
