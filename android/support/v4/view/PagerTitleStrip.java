...
public class PagerTitleStrip extends ViewGroup {
  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4) {
    if (this.mPager != null) {
      float f1 = this.mLastKnownPositionOffset;
      float f2 = 0.0F;
      if (f1 >= 0.0F)
  ...
  void updateTextPositions(int paramInt, float paramFloat, boolean paramBoolean) {
    ...
    i7 = this.mCurrText.getMeasuredHeight();
    int i10 = this.mNextText.getMeasuredHeight();
    i9 = Math.max(Math.max(i9 + i6, i7 + j), i10 + i8);
    i7 = this.mGravity & 0x70;
    if (i7 != 16) {
      if (i7 != 80) {
        i4 = i6 + paramInt;
        j += paramInt;
      ...
      paramInt = (i1 - paramInt - i4 - i9) / 2;
      i4 = i6 + paramInt;
      j += paramInt;
      paramInt += i8;
    } 
    this.mCurrText.layout(i5, j, m, this.mCurrText.getMeasuredHeight() + j);
    j = Math.min(i2, i5 - this.mScaledTextSpacing - i);
    this.mPrevText.layout(j, i4, i + j, this.mPrevText.getMeasuredHeight() + i4);
...
/* Location:              C:\Users\rafal\Downloads\Mobius_jar.jar!\android\support\v4\view\PagerTitleStrip.class
