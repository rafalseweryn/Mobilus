...
public class FragmentActivity extends SupportActivity implements ViewModelStoreOwner, ActivityCompat.OnRequestPermissionsResultCallback, ActivityCompat.RequestPermissionsRequestCodeValidator {
  ...
  public boolean onCreatePanelMenu(int paramInt, Menu paramMenu) {
    if (paramInt == 0) {
      ...
      return this.mFragments.dispatchCreateOptionsMenu(paramMenu, getMenuInflater()) | bool;
    } 
  ...
  public boolean onPreparePanel(int paramInt, View paramView, Menu paramMenu) {
    if (paramInt == 0 && paramMenu != null) {
      boolean bool = onPrepareOptionsPanel(paramView, paramMenu);
      return this.mFragments.dispatchPrepareOptionsMenu(paramMenu) | bool;
    } 
...
/* Location:              C:\Users\rafal\Downloads\Mobius_jar.jar!\android\support\v4\app\FragmentActivity.class
