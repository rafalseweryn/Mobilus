...
public final class NotificationManagerCompat {
  ...
  public static Set<String> getEnabledListenerPackages(@NonNull Context paramContext) {
    ...
    Set<String> set = sEnabledNotificationListenerPackages;
...
/* Location:              C:\Users\rafal\Downloads\Mobius_jar.jar!\android\support\v4\app\NotificationManagerCompat.class
