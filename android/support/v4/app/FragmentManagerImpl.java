...
final class FragmentManagerImpl extends FragmentManager implements LayoutInflater.Factory2 {
  ...
  public boolean dispatchCreateOptionsMenu(Menu paramMenu, MenuInflater paramMenuInflater) {
    ...
    byte b2 = 0;
    for (i = b2; b2 < this.mAdded.size(); i = j) {
      Fragment fragment = this.mAdded.get(b2);
    ...
    if (this.mCreatedMenus != null)
      for (byte b = b1; b < this.mCreatedMenus.size(); b++) {
...
/* Location:              C:\Users\rafal\Downloads\Mobius_jar.jar!\android\support\v4\app\FragmentManagerImpl.class
