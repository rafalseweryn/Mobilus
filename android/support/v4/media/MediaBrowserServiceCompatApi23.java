...
class MediaBrowserServiceCompatApi23 {
  ...
  static class MediaBrowserServiceAdaptor extends MediaBrowserServiceCompatApi21.MediaBrowserServiceAdaptor {
    ...
    public void onLoadItem(String param1String, MediaBrowserService.Result<MediaBrowser.MediaItem> param1Result) {
      ((MediaBrowserServiceCompatApi23.ServiceCompatProxy)this.mServiceProxy).onLoadItem(param1String, new MediaBrowserServiceCompatApi21.ResultWrapper<>(param1Result));
    }
  }
...
/* Location:              C:\Users\rafal\Downloads\Mobius_jar.jar!\android\support\v4\media\MediaBrowserServiceCompatApi23.class
