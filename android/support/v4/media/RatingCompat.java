...
public final class RatingCompat implements Parcelable {
  ...
  public static RatingCompat fromRating(Object paramObject) {
    if (paramObject != null && Build.VERSION.SDK_INT >= 19) {
      ...
      Rating rating = (Rating)paramObject;
      int i = rating.getRatingStyle();
      if (rating.isRated()) {
        switch (i) {
          default:
            return null;
...
/* Location:              C:\Users\rafal\Downloads\Mobius_jar.jar!\android\support\v4\media\RatingCompat.class
