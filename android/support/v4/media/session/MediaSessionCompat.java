...
public class MediaSessionCompat {
      ...
      if (l1 != -1L) {
        if (paramPlaybackStateCompat.getState() == 3 || paramPlaybackStateCompat.getState() == 4 || paramPlaybackStateCompat.getState() == 5) {
          ...
          if (l1 > 0L) {
            ...
            long l4 = (long)(paramPlaybackStateCompat.getPlaybackSpeed() * (float)(l3 - l1)) + paramPlaybackStateCompat.getPosition();
            l1 = l2;
  ...
  public static abstract class Callback {
    ...
    public boolean onMediaButtonEvent(Intent param1Intent) {
      ...
      if (keyEvent.getRepeatCount() > 0) {
        ...
        this.mCallbackHandler.sendMessageDelayed(this.mCallbackHandler.obtainMessage(1, remoteUserInfo), ViewConfiguration.getDoubleTapTimeout());
      } 
      return true;
    }
    ...
    private class StubApi21 implements MediaSessionCompatApi21.Callback {
      public void onCommand(String param2String, Bundle param2Bundle, ResultReceiver param2ResultReceiver) {
        try {
          ...
          } else if (iBinder.equals("android.support.v4.media.session.command.ADD_QUEUE_ITEM")) {
          ...
          } else if (iBinder.equals("android.support.v4.media.session.command.ADD_QUEUE_ITEM_AT")) {
    ...
    class ExtraSession extends IMediaSession.Stub {
      ...
      public void registerCallbackListener(IMediaControllerCallback param2IMediaControllerCallback) {
        if (!MediaSessionCompat.MediaSessionImplApi21.this.mDestroyed) {
          String str1 = MediaSessionCompat.MediaSessionImplApi21.this.getCallingPackage();
          String str2 = str1;
          if (str1 == null)
            str2 = "android.media.session.MediaController"; 
          MediaSessionManager.RemoteUserInfo remoteUserInfo = new MediaSessionManager.RemoteUserInfo(str2, getCallingPid(), getCallingUid());
  ...
  class ExtraSession extends IMediaSession.Stub {
    ...
    public void registerCallbackListener(IMediaControllerCallback param1IMediaControllerCallback) {
      if (!this.this$0.mDestroyed) {
        String str1 = this.this$0.getCallingPackage();
        String str2 = str1;
        if (str1 == null)
          str2 = "android.media.session.MediaController"; 
        MediaSessionManager.RemoteUserInfo remoteUserInfo = new MediaSessionManager.RemoteUserInfo(str2, getCallingPid(), getCallingUid());
  ...
  static class MediaSessionImplBase implements MediaSessionImpl {
    ...
    void postToHandler(int param1Int1, int param1Int2, int param1Int3, Object param1Object, Bundle param1Bundle) {
      synchronized (this.mLock) {
        if (this.mHandler != null) {
          Message message = this.mHandler.obtainMessage(param1Int1, param1Int2, param1Int3, param1Object);
          param1Object = new Bundle();
          super();
          param1Object.putString("data_calling_pkg", "android.media.session.MediaController");
          param1Object.putInt("data_calling_pid", Binder.getCallingPid());
          param1Object.putInt("data_calling_uid", Binder.getCallingUid());
          if (param1Bundle != null)
            param1Object.putBundle("data_extras", param1Bundle); 
          message.setData((Bundle)param1Object);
    ...
    class MessageHandler extends Handler {
      ...
      public void handleMessage(Message param2Message) {
        ...
        MediaSessionCompat.ensureClassLoader(bundle);
        MediaSessionCompat.MediaSessionImplBase.this.setCurrentControllerInfo(new MediaSessionManager.RemoteUserInfo(bundle.getString("data_calling_pkg"), bundle.getInt("data_calling_pid"), bundle.getInt("data_calling_uid")));
  ...
  public static final class Token implements Parcelable {
    ...
    public static Token fromBundle(Bundle param1Bundle) {
      ...
      Token token1 = (Token)param1Bundle.getParcelable("android.support.v4.media.session.TOKEN");
      if (token1 == null) {
        token1 = token2;
      } else {
        token1 = new Token(token1.mInner, iMediaSession, bundle);
      } 
      return token1;
    }
...
/* Location:              C:\Users\rafal\Downloads\Mobius_jar.jar!\android\support\v4\media\session\MediaSessionCompat.class
