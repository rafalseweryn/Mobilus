...
public final class MediaControllerCompat {
  ...
  public MediaControllerCompat(Context paramContext, @NonNull MediaSessionCompat paramMediaSessionCompat) {
    ...
    try {
      ...
      if (Build.VERSION.SDK_INT >= 24) {
        MediaControllerImplApi24 mediaControllerImplApi241 = new MediaControllerImplApi24();
        this(paramContext, this.mToken);
        mediaControllerImplApi24 = mediaControllerImplApi241;
      } else {
  ...
  public static abstract class Callback implements IBinder.DeathRecipient {
    ...
    void postToHandler(int param1Int, Object param1Object, Bundle param1Bundle) {
      if (this.mHandler != null) {
        param1Object = this.mHandler.obtainMessage(param1Int, param1Object);
    ...
    private static class StubApi21 implements MediaControllerCompatApi21.Callback {
      ...
      StubApi21(MediaControllerCompat.Callback param2Callback) {
        this.mCallback = new WeakReference<>(param2Callback);
      }
  ...
  private static class StubApi21 implements MediaControllerCompatApi21.Callback {
    ...
    StubApi21(MediaControllerCompat.Callback param1Callback) {
      this.mCallback = new WeakReference<>(param1Callback);
    }
  ...
  static class MediaControllerImplApi21 implements MediaControllerImpl {
    ...
    private static class ExtraBinderRequestResultReceiver extends ResultReceiver {
      ...
      ExtraBinderRequestResultReceiver(MediaControllerCompat.MediaControllerImplApi21 param2MediaControllerImplApi21) {
        super(null);
        this.mMediaControllerImpl = new WeakReference<>(param2MediaControllerImplApi21);
      }
  ...
  private static class ExtraBinderRequestResultReceiver extends ResultReceiver {
    ...
    ExtraBinderRequestResultReceiver(MediaControllerCompat.MediaControllerImplApi21 param1MediaControllerImplApi21) {
      super(null);
      this.mMediaControllerImpl = new WeakReference<>(param1MediaControllerImplApi21);
    }
  ...
  static class MediaControllerImplBase implements MediaControllerImpl {
    ...
    public void addQueueItem(MediaDescriptionCompat param1MediaDescriptionCompat) {
      try {
        ...
        this.mBinder.addQueueItem((MediaDescriptionCompat)unsupportedOperationException);
      } catch (RemoteException remoteException) {
    ...
    public void addQueueItem(MediaDescriptionCompat param1MediaDescriptionCompat, int param1Int) {
      try {
        ...
        this.mBinder.addQueueItemAt((MediaDescriptionCompat)unsupportedOperationException, param1Int);
      } catch (RemoteException remoteException) {
    ...
    public void removeQueueItem(MediaDescriptionCompat param1MediaDescriptionCompat) {
      try {
        ...
        this.mBinder.removeQueueItem((MediaDescriptionCompat)unsupportedOperationException);
      } catch (RemoteException remoteException) {
...
/* Location:              C:\Users\rafal\Downloads\Mobius_jar.jar!\android\support\v4\media\session\MediaControllerCompat.class
