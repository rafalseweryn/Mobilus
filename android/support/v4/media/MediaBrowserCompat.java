...
public final class MediaBrowserCompat {
  ...
  private static class CallbackHandler extends Handler {
    ...
    CallbackHandler(MediaBrowserCompat.MediaBrowserServiceCallbackImpl param1MediaBrowserServiceCallbackImpl) {
      this.mCallbackImplRef = new WeakReference<>(param1MediaBrowserServiceCallbackImpl);
    }
    ...
    public void handleMessage(Message param1Message) {
      ...
      try {
        ...
        switch (param1Message.what) {
          case 3:
            bundle1 = bundle.getBundle("data_options");
            MediaSessionCompat.ensureClassLoader(bundle1);
            bundle2 = bundle.getBundle("data_notify_children_changed_options");
            MediaSessionCompat.ensureClassLoader(bundle2);
            mediaBrowserServiceCallbackImpl.onLoadChildren(messenger, bundle.getString("data_media_item_id"), bundle.getParcelableArrayList("data_media_item_list"), bundle1, bundle2);
            return;
          case 2:
            mediaBrowserServiceCallbackImpl.onConnectionFailed(messenger);
            return;
          case 1:
            bundle2 = bundle.getBundle("data_root_hints");
            MediaSessionCompat.ensureClassLoader(bundle2);
            mediaBrowserServiceCallbackImpl.onServiceConnected(messenger, bundle.getString("data_media_item_id"), (MediaSessionCompat.Token)bundle.getParcelable("data_media_session_token"), bundle2);
            return;
        } 
    ...
    void setCallbacksMessenger(Messenger param1Messenger) {
      this.mCallbacksMessengerRef = new WeakReference<>(param1Messenger);
    }
  }
  ...
  static class MediaBrowserImplApi21 implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl, ConnectionCallback.ConnectionCallbackInternal {
    ...
    public void onLoadChildren(Messenger param1Messenger, String param1String, List<MediaBrowserCompat.MediaItem> param1List, Bundle param1Bundle1, Bundle param1Bundle2) {
      ...
      MediaBrowserCompat.SubscriptionCallback subscriptionCallback = stringBuilder.getCallback(param1Bundle1);
    ...
    public void sendCustomAction(@NonNull final String action, final Bundle extras, @Nullable MediaBrowserCompat.CustomActionCallback param1CustomActionCallback) {
      final StringBuilder callback;
      if (!isConnected()) {
        stringBuilder = new StringBuilder();
      ...
      MediaBrowserCompat.CustomActionResultReceiver customActionResultReceiver = new MediaBrowserCompat.CustomActionResultReceiver(action, extras, (MediaBrowserCompat.CustomActionCallback)stringBuilder, this.mHandler);
      try {
  ...
  static class MediaBrowserImplBase implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl {
    ...
    private boolean isCurrent(Messenger param1Messenger, String param1String) {
      if (this.mCallbacksMessenger != param1Messenger || this.mState == 0 || this.mState == 1) {
      ...
      this.mHandler.post(new Runnable() {
            public void run() {
              ...
              if (MediaBrowserCompat.MediaBrowserImplBase.this.mServiceBinderWrapper != null) {
                ...
                stringBuilder.append(MediaBrowserCompat.MediaBrowserImplBase.this.mServiceBinderWrapper);
                throw new RuntimeException(stringBuilder.toString());
              } 
              if (MediaBrowserCompat.MediaBrowserImplBase.this.mCallbacksMessenger != null) {
                ...
                stringBuilder.append(MediaBrowserCompat.MediaBrowserImplBase.this.mCallbacksMessenger);
                throw new RuntimeException(stringBuilder.toString());
              } 
              Intent intent = new Intent("android.media.browse.MediaBrowserService");
              intent.setComponent(MediaBrowserCompat.MediaBrowserImplBase.this.mServiceComponent);
              MediaBrowserCompat.MediaBrowserImplBase.this.mServiceConnection = new MediaBrowserCompat.MediaBrowserImplBase.MediaServiceConnection();
              try {
                bool = MediaBrowserCompat.MediaBrowserImplBase.this.mContext.bindService(intent, MediaBrowserCompat.MediaBrowserImplBase.this.mServiceConnection, 1);
      ...
      try {
        for (Map.Entry entry : this.mSubscriptions.entrySet()) {
          ...
          for (byte b = 0; b < list.size(); b++)
            this.mServiceBinderWrapper.addSubscription(param1String, ((MediaBrowserCompat.SubscriptionCallback)list.get(b)).mToken, list1.get(b), this.mCallbacksMessenger); 
        } 
      } catch (RemoteException remoteException) {
    ...
    public void search(@NonNull String param1String, final Bundle extras, @NonNull final MediaBrowserCompat.SearchCallback callback) {
      ...
      MediaBrowserCompat.SearchResultReceiver searchResultReceiver = new MediaBrowserCompat.SearchResultReceiver((String)stringBuilder, extras, callback, this.mHandler);
      try {
        this.mServiceBinderWrapper.search((String)stringBuilder, extras, searchResultReceiver, this.mCallbacksMessenger);
      } catch (RemoteException remoteException) {
        StringBuilder stringBuilder1 = new StringBuilder();
  ...
  class null implements Runnable {
    public void run() {
      ...
      this.this$0.mServiceConnection = new MediaBrowserCompat.MediaBrowserImplBase.MediaServiceConnection();
      try {
        bool = this.this$0.mContext.bindService(intent, this.this$0.mServiceConnection, 1);
      } catch (Exception exception) {
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("Failed binding to service ");
  ...
  static interface MediaBrowserServiceCallbackImpl {
    ...
    void onLoadChildren(Messenger param1Messenger, String param1String, List param1List, Bundle param1Bundle1, Bundle param1Bundle2);
  ...
  public static abstract class SubscriptionCallback {
    ...
    void setSubscription(MediaBrowserCompat.Subscription param1Subscription) {
      this.mSubscriptionRef = new WeakReference<>(param1Subscription);
    }
...
/* Location:              C:\Users\rafal\Downloads\Mobius_jar.jar!\android\support\v4\media\MediaBrowserCompat.class
