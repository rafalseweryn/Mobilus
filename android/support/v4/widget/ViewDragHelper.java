      ...
      case 5:
        ...
        if (this.mDragState == 0) {
          ...
          if ((this.mTrackingEdges & k) != 0)
            this.mCallback.onEdgeTouched(this.mTrackingEdges & k, m); 
      ...
      case 2:
        if (this.mDragState == 1) {
          if (isValidPointerForActionMove(this.mActivePointerId)) {
            ...
            k = (int)(f2 - this.mLastMotionX[this.mActivePointerId]);
            m = (int)(f1 - this.mLastMotionY[this.mActivePointerId]);
            dragTo(this.mCapturedView.getLeft() + k, this.mCapturedView.getTop() + m, k, m);
      ...
      case 2:
        ...
        for (i = 0; i < k; i++) {
          ...
          if (isValidPointerForActionMove(m)) {
            float f3 = view.getX(i);
            f1 = view.getY(i);
            float f4 = f3 - this.mInitialMotionX[m];
            f2 = f1 - this.mInitialMotionY[m];
            View view1 = findTopChildUnder((int)f3, (int)f1);
            if (view1 != null && checkTouchSlop(view1, f4, f2)) {
              j = 1;
            } else {
              j = 0;
            } 
...
/* Location:              C:\Users\rafal\Downloads\Mobius_jar.jar!\android\support\v4\widget\ViewDragHelper.class
