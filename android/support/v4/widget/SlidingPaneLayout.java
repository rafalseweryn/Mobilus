...
public class SlidingPaneLayout extends ViewGroup {
  ...
  protected void onMeasure(int paramInt1, int paramInt2) {
    ...
    float f2 = 0.0F;
    int i4 = i3;
    for (paramInt2 = paramInt1; i4 < i2; paramInt2 = paramInt1) {
      int i6;
      ...
      for (j = 0; j < i2; j++) {
        ...
        if (view.getVisibility() != 8) {
          ...
          if (view.getVisibility() != 8) {
            ...
            if (i3 != 0 && view != this.mSlideableView) {
              if (layoutParams.width < 0 && (i4 > n || layoutParams.weight > 0.0F)) {
                if (paramInt1 != 0) {
                  if (layoutParams.height == -2) {
              ...
              if (i3 != 0) {
                ...
                int i5 = Math.max(0, i);
                view.measure(View.MeasureSpec.makeMeasureSpec(i4 + (int)(layoutParams.weight * i5 / f1), 1073741824), paramInt1);
              } 
            } 
          } 
        } 
    ...
    setMeasuredDimension(m, paramInt2 + getPaddingTop() + getPaddingBottom());
    this.mCanSlide = i3;
    if (this.mDragHelper.getViewDragState() != 0 && i3 == 0)
      this.mDragHelper.abort(); 
  }
...
/* Location:              C:\Users\rafal\Downloads\Mobius_jar.jar!\android\support\v4\widget\SlidingPaneLayout.class
