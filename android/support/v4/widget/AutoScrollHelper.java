...
public abstract class AutoScrollHelper implements View.OnTouchListener {
  ...
  private float computeTargetVelocity(int paramInt, float paramFloat1, float paramFloat2, float paramFloat3) {
    ...
    float f2 = this.mMinimumVelocity[paramInt];
    paramFloat1 = this.mMaximumVelocity[paramInt];
    paramFloat3 = f1 * paramFloat3;
    return (i > 0) ? constrain(paramFloat2 * paramFloat3, f2, paramFloat1) : -constrain(-paramFloat2 * paramFloat3, f2, paramFloat1);
  }
...
/* Location:              C:\Users\rafal\Downloads\Mobius_jar.jar!\android\support\v4\widget\AutoScrollHelper.class
