...
public class AnimatedVectorDrawableCompat extends VectorDrawableCommon implements Animatable2Compat {
  ...
  public static AnimatedVectorDrawableCompat create(@NonNull Context paramContext, @DrawableRes int paramInt) {
    ...
    try {
      ...
      return createFromXmlInner((Context)xmlPullParserException, xmlPullParserException.getResources(), (XmlPullParser)xmlResourceParser, attributeSet, xmlPullParserException.getTheme());
  ...
  public int getChangingConfigurations() {
    ...
    return this.mAnimatedVectorState.mChangingConfigurations | i;
  }
...
/* Location:              C:\Users\rafal\Downloads\Mobius_jar.jar!\android\support\graphics\drawable\AnimatedVectorDrawableCompat.class
