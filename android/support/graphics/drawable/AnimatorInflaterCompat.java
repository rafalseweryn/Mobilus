...
public class AnimatorInflaterCompat {
        ...
        if (str.equals("objectAnimator")) {
          ...
          if (objectAnimator.equals("animator")) {
            ...
            if (valueAnimator.equals("set")) {
              ...
              k = TypedArrayUtils.getNamedInt(typedArray, paramXmlPullParser, "ordering", 0, 0);
  ...
  private static void setupObjectAnimator(ValueAnimator paramValueAnimator, TypedArray paramTypedArray, int paramInt, float paramFloat, XmlPullParser paramXmlPullParser) {
    ...
    //   68: aload_0
    //   69: aload_1
    //   70: invokevirtual getPositionDescription : ()Ljava/lang/String;
    //   73: invokevirtual append : (Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   76: pop
    //   77: aload_0
    //   78: ldc_w ' propertyXName or propertyYName is needed for PathData'
    //   81: invokevirtual append : (Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   84: pop
    //   85: new android/view/InflateException
    //   88: dup
    //   89: aload_0
    ...
    //   96: athrow
    //   97: aload_0
    //   98: invokestatic createPathFromPathData : (Ljava/lang/String;)Landroid/graphics/Path;
    //   101: aload #5
    //   103: fload_3
    //   104: ldc_w 0.5
    //   107: fmul
    ...
    //   120: aload_1
    //   121: aload #4
    //   123: ldc_w 'propertyName'
    //   126: iconst_0
    //   127: invokestatic getNamedString : (Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;I)Ljava/lang/String;
    //   130: invokevirtual setPropertyName : (Ljava/lang/String;)V
    //   133: return
  }
    ...
    while (true) {
      ...
      if (!pathMeasure.nextContour()) {
        ...
        while (true) {
          ...
          pathMeasure = null;
          if (k < i) {
            pathMeasure1.getPosTan(paramFloat - ((Float)arrayList.get(j)).floatValue(), arrayOfFloat1, null);
            arrayOfFloat2[k] = arrayOfFloat1[0];
            arrayOfFloat3[k] = arrayOfFloat1[1];
            paramFloat += f;
            int m = j + 1;
            int n = j;
            if (m < arrayList.size()) {
...
/* Location:              C:\Users\rafal\Downloads\Mobius_jar.jar!\android\support\graphics\drawable\AnimatorInflaterCompat.class
