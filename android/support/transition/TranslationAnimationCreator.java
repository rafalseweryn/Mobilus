...
class TranslationAnimationCreator {
  ...
  private static class TransitionPositionListener extends AnimatorListenerAdapter {
    ...
    TransitionPositionListener(View param1View1, View param1View2, int param1Int1, int param1Int2, float param1Float1, float param1Float2) {
      ...
      this.mStartX = param1Int1 - Math.round(this.mMovingView.getTranslationX());
...
/* Location:              C:\Users\rafal\Downloads\Mobius_jar.jar!\android\support\transition\TranslationAnimationCreator.class
