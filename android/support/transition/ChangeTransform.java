...
public class ChangeTransform extends Transition {
  ...
  private boolean parentsMatch(ViewGroup paramViewGroup1, ViewGroup paramViewGroup2) {
    ...
    if (!bool || !isValidTarget((View)paramViewGroup2)) {
      bool = bool1;
      return (paramViewGroup1 == paramViewGroup2) ? true : bool;
    } 
  ...
  private static class Transforms {
    ...
    public int hashCode() {
      ...
      int i = 0;
      if (f != 0.0F) {
        b1 = Float.floatToIntBits(this.mTranslationX);
      } else {
        b1 = 0;
      } 
      if (this.mTranslationY != 0.0F) {
        b2 = Float.floatToIntBits(this.mTranslationY);
      } else {
        b2 = 0;
      } 
      if (this.mTranslationZ != 0.0F) {
        b3 = Float.floatToIntBits(this.mTranslationZ);
      } else {
        b3 = 0;
      } 
      if (this.mScaleX != 0.0F) {
        b4 = Float.floatToIntBits(this.mScaleX);
      } else {
        b4 = 0;
      } 
      if (this.mScaleY != 0.0F) {
        b5 = Float.floatToIntBits(this.mScaleY);
      } else {
        b5 = 0;
      } 
      if (this.mRotationX != 0.0F) {
        b6 = Float.floatToIntBits(this.mRotationX);
      } else {
        b6 = 0;
      } 
      if (this.mRotationY != 0.0F) {
        b7 = Float.floatToIntBits(this.mRotationY);
      } else {
        b7 = 0;
      } 
...
/* Location:              C:\Users\rafal\Downloads\Mobius_jar.jar!\android\support\transition\ChangeTransform.class
