...
class GhostViewApi14 extends View implements GhostViewImpl {
  ...
  static void removeGhost(View paramView) {
    ...
    if (paramView != null) {
      ((GhostViewApi14)paramView).mReferences--;
      if (((GhostViewApi14)paramView).mReferences <= 0) {
...
/* Location:              C:\Users\rafal\Downloads\Mobius_jar.jar!\android\support\transition\GhostViewApi14.class
