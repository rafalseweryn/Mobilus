    ...
    ((Transition)paramObject1).addListener(new Transition.TransitionListener() {
          ...
          public void onTransitionStart(@NonNull Transition param1Transition) {
            if (enterTransition != null)
              FragmentTransitionSupport.this.replaceTargets(enterTransition, enteringViews, (ArrayList<View>)null); 
            if (exitTransition != null)
              FragmentTransitionSupport.this.replaceTargets(exitTransition, exitingViews, (ArrayList<View>)null); 
            if (sharedElementTransition != null)
              FragmentTransitionSupport.this.replaceTargets(sharedElementTransition, sharedElementsIn, (ArrayList<View>)null); 
          }
        });
  }
  ...
  public void setEpicenter(Object paramObject, final Rect epicenter) {
    if (paramObject != null)
      ((Transition)paramObject).setEpicenterCallback(new Transition.EpicenterCallback() {
            public Rect onGetEpicenter(@NonNull Transition param1Transition) {
...
/* Location:              C:\Users\rafal\Downloads\Mobius_jar.jar!\android\support\transition\FragmentTransitionSupport.class
