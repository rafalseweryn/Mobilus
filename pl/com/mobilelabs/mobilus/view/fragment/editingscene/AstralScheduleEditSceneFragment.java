...
public class AstralScheduleEditSceneFragment extends EditingSceneFragment {
  ...
  protected void hourlyButtonClicked() {
    EditingSceneChildActivity editingSceneChildActivity = (EditingSceneChildActivity)getActivity();
    if (editingSceneChildActivity != null)
      editingSceneChildActivity.changeView(2131492929, new HourlyScheduleEditSceneFragment()); 
  }
  ...
  protected void saveButtonClicked() {
    Scene scene = extractScene();
    if (scene != null) {
      ArrayList arrayList = scene.extractAstralSchedules();
      if (arrayList.size() > 0) {
        this.managementServiceBinder.editSceneSceneAstralSchedules(scene.getId(), arrayList);
      } else {
...
/* Location:              C:\Users\rafal\Downloads\Mobius_jar.jar!\pl\com\mobilelabs\mobilus\view\fragment\editingscene\AstralScheduleEditSceneFragment.class
