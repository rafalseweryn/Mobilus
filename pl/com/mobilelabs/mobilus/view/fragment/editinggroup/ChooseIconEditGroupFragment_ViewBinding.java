...
public class ChooseIconEditGroupFragment_ViewBinding implements Unbinder {
  private ChooseIconEditGroupFragment target;
  
  private View view2131296496;
  
  @UiThread
  public ChooseIconEditGroupFragment_ViewBinding(final ChooseIconEditGroupFragment target, View paramView) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    ChooseIconEditGroupFragment chooseIconEditGroupFragment = this.target;
    if (chooseIconEditGroupFragment == null)
      throw new IllegalStateException("Bindings already cleared."); 
    this.target = null;
    chooseIconEditGroupFragment.groupName = null;
    chooseIconEditGroupFragment.groupIcon = null;
    chooseIconEditGroupFragment.recyclerView = null;
    chooseIconEditGroupFragment.saveButtonTitle = null;
...
/* Location:              C:\Users\rafal\Downloads\Mobius_jar.jar!\pl\com\mobilelabs\mobilus\view\fragment\editinggroup\ChooseIconEditGroupFragment_ViewBinding.class
