...
public abstract class AddingPlaceFragment extends DoSthDeviceFragment {
  protected BroadcastReceiver broadcastReceiver = new BroadcastReceiver() {
      public void onReceive(Context param1Context, Intent param1Intent) {
        AddingPlaceFragment.this.broadcastReceived(param1Context, param1Intent);
      }
    };
  ...
  protected Place extractPlace() {
    ...
    return (addingPlaceActivity != null) ? addingPlaceActivity.getNewPlace() : null;
  }
...
/* Location:              C:\Users\rafal\Downloads\Mobius_jar.jar!\pl\com\mobilelabs\mobilus\view\fragment\addingplace\AddingPlaceFragment.class
