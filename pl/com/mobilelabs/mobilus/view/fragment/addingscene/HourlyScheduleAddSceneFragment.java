...
public class HourlyScheduleAddSceneFragment extends AddingSceneFragment {
  ...
  protected void astralButtonClicked() {
    ...
    if (addingSceneActivity != null)
      addingSceneActivity.changeView(2131492902, new AstralScheduleAddSceneFragment()); 
  }
  ...
  protected void saveButtonClicked() {
    Scene scene = extractScene();
    if (scene != null)
      if (scene.extractWeekSchedules().size() > 0) {
        scene.generateWeekSchedules();
    ...
    if (scene != null) {
      ...
      (new TimePickerDialog((Context)getActivity(), 2131690000, new TimePickerDialog.OnTimeSetListener() {
            public void onTimeSet(TimePicker param1TimePicker, int param1Int1, int param1Int2) {
              HourlyScheduleAddSceneFragment.this.setHourMinute(param1Int1, param1Int2);
            }
          }i, j, true)).show();
    } 
  }
...
/* Location:              C:\Users\rafal\Downloads\Mobius_jar.jar!\pl\com\mobilelabs\mobilus\view\fragment\addingscene\HourlyScheduleAddSceneFragment.class
