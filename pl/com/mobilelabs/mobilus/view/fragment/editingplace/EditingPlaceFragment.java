...
public abstract class EditingPlaceFragment extends DoSthDeviceFragment {
  protected BroadcastReceiver broadcastReceiver = new BroadcastReceiver() {
      public void onReceive(Context param1Context, Intent param1Intent) {
        EditingPlaceFragment.this.broadcastReceived(param1Context, param1Intent);
      }
    };
  ...
  protected Place extractPlace() {
    ...
    //   66: invokevirtual getPlaces : ()Ljava/util/ArrayList;
    ...
    //   91: checkcast pl/com/mobilelabs/mobilus/model/objects/Place
    //   94: astore_1
    //   95: aload_1
  ...
  protected void newConfigurationReceived(Context paramContext, Intent paramIntent) {
    ...
    if (extractPlace() == null && ultimateHeaderActivity != null)
...
/* Location:              C:\Users\rafal\Downloads\Mobius_jar.jar!\pl\com\mobilelabs\mobilus\view\fragment\editingplace\EditingPlaceFragment.class
